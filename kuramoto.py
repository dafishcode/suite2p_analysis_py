...
class Kuramoto(object):
    ...
    def __init__(self, init_values, noise=None):
        ...
        self.dt = 1.
        self.init_phase = np.array(init_values['Y0']) #Y0 = initial phase
        self.W = np.array(init_values['W'])           #W = intrinsic frequencyes
        self.K = np.array(init_values['K'])           #K = coupling matrix
